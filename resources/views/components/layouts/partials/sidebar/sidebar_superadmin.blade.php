<ul class="menu">
    ...
    {{-- Master Absensi --}}
    <li class="sidebar-item has-sub {{ Request::routeIs('admin.master-absensi*') ? 'active' : '' }}">
        <a href="" class='sidebar-link'>
            <i class="bi bi-journal-text"></i>
        ...
        <ul class="submenu ">
            <li class="submenu-item  ">
                <a href="{{ route('admin.piket.dashboard') }}" wire:navigate  class="submenu-link {{ Request::routeIs('admin.master-absensi.dashboard') ? 'text-primary fs-6' : '' }}">Dashboard</a>
            </li>
        </ul>
    </li>
