            ...
            <div class="flex justify-between items-center h-16">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        <a href="#" class="text-primary px-3 py-2 rounded-md text-sm font-medium bg-blue-50">Dashboard</a>
                        ...
                        <a href="#" wire:click="logout" class="bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-red-600 transition duration-300">Keluar</a>
                    </div>
                </div>
                <div class="md:hidden">
