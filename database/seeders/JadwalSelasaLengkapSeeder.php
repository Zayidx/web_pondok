...
class JadwalSelasaLengkapSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // 3. Menyiapkan data jadwal penuh untuk hari rabu.
        ...
        foreach ($jadwals as $jadwal) {
            JadwalPelajaran::updateOrCreate(
                ...
                [
                    ...
                    'hari' => 'rabu', // Mencari dengan huruf kecil
                    'waktu_mulai' => $jadwal['waktu_mulai'],
                ],
                // Data yang akan dibuat atau diupdate
                array_merge($jadwal, [
                    'hari' => 'rabu', // Membuat dengan huruf kecil agar sesuai dengan logika aplikasi
                    'role_guru' => 'umum'
                ])
            );
        }
