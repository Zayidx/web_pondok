                        ...
                        <div class="p-5">
                            <table class="w-full">
                                <tbody>
                                    ...
                                    <tr class="border-b border-gray-100">
                                        <td class="py-3 font-medium text-gray-700">Total Nilai</td>
                                        <td class="py-3 text-gray-600">: {{ $totalNilai ?? 0 }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <div class="mt-4">
                                <a href="{{ route('e-ppdb.ujian.detail-soal', ['ujianId' => $ujian->id, 'santriId' => $santri->id]) }}" 
