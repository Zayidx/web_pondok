        ...
        <tr>
            <td style="width: 50%;">   
                ...
                <div style="height: 90px; position: relative;">
                    @if($settings->ttd_direktur_path)
                    <img src="{{ $settings->ttd_direktur_path }}" alt="Tanda Tangan Direktur" style="max-width: 110px; opacity: 0.9; position: absolute; left: 50%; top: -10px; transform: translateX(-50%);">
                    @endif
                </div>
            ...
            <td style="width: 50%;">
                ...
                <div style="height: 90px; position: relative;">
                    @if($settings->ttd_admin_path)
                    <img src="{{ $settings->ttd_admin_path }}" alt="Tanda Tangan Admin" style="max-width: 110px; opacity: 0.9; position: absolute; left: 50%; top: -10px; transform: translateX(-50%);">
                    @endif
                </div>
